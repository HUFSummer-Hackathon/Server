...
import hackathon.nomadworker.domain.util.Direction;
import hackathon.nomadworker.domain.util.GeometryUtil;
import hackathon.nomadworker.domain.util.Location;
